      ...
      <div className="mx-auto mt-32 flex w-8/12 flex-col gap-10 text-center md:flex-row">
        <div className="w-full md:w-1/3">
          <Image
            ...
            alt=""
          />
          <h3 className="mt-10 text-3xl font-bold uppercase">Kids provision</h3>
          <p>
            Fantastic kids events will be available separately from the main
            events for 2-11 year olds with dedicated DBS checked volunteers!
          </p>
        </div>
        <div className="w-full md:w-1/3">
          <Image
        ...
        <div className="w-full md:w-1/3">
          <Image
            ...
            alt=""
          />
          <h3 className="mt-10 text-3xl font-bold uppercase">Double event</h3>
          <p>
            Join us either in the morning or evening for an unforgettable
            celebration. A candlelight setting will be presented at both events!
          </p>
        </div>
      </div>
      <div className="mt-24">
