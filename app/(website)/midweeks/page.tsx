    ...
    <>
      ...
      <div className="container mt-12 mb-16">
        <div className="md:w-8/12 lg:w-1/2">
          ...
          <p className="para">
            We are made in the image of the ultimate creator, and in our
            Saltwinds stream we&apos;ll be looking at the ways that we can
            activate the vision God has given us for new levels of expression
            and creativity in our church. We will spend the year learning about
            God&apos;s desire for our creative skills to be used for him, and
            finding ways to serve our Sunday events and social media impact
            using those skills. So whether you are a poet, a video editor, a
            TikTok genius or a song-writing novice, why not jump into this
            stream of people committed to using what is in their hands, and
