      ...
      <div className="section">
        <div className="container mt-10">
          ...
          <p className="para mx-auto text-lg lg:w-8/12">
            ...
            to us; we&apos;re not meant to walk alone. Our pursuit is to live
            fully, leaving a lasting impact by having audacious faith, trusting
          ...
          <div className="container gap-10 md:flex">
            ...
            <div className="mt-8 flex flex-col justify-center md:mt-0 md:w-1/2">
              <p className="para text-lg text-white">
                ...
                of the gospel in relevant, accessible forms. Our vision is
                Connecting Anyone Anywhere, to a Life Changing Relationship with
                Jesus. Freedom Church is led by our Senior Pastors, Gary and
                Heather Snowzell and our Directional Leadership Team, with each
                Campus or Firestarter being led by a Campus or Location leader.
              </p>
            </div>
          </div>
        </div>
